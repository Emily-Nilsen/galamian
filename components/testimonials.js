    ...
    <div className="bg-white pt-16 lg:pt-24">
      <div className="relative max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
        {testimonials.map((testimonial) => (
          <div className="absolute top-0 left-0" key={testimonial.author}>
            <div className="relative py-24 px-8 bg-gold-600 lg:px-16 lg:grid lg:grid-cols-2 lg:gap-x-8 h-full">
