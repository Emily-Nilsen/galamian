  ...
  return (
    <section id="planesDeEstudios" className="bg-white">
      <div className="max-w-2xl mx-auto py-4 px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-3xl sm:text-4xl font-normal tracking-wide text-gray-900">
          Planes de Estudios
        </h2>
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {instruments.map((instrument) => (
            <div key={instrument.id} className="group relative">
              <div className="w-full min-h-80 bg-gray-200 aspect-w-1 aspect-h-1 overflow-hidden group-hover:opacity-75  lg:aspect-none lg:h-80 transition duration-200 ease-in-out">
