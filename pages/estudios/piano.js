...
export default function Piano() {
  ...
  return (
    <Layout
      title={t('layout:piano_title')}
      description={t('layout:piano_description')}
      keywords={t('layout:piano_keywords')}
    >
        ...
        <div className="px-4 py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-xl mx-auto mt-5 text-xl text-neutral-600">
              {t('piano:text_part_1')} {new Date().getFullYear()}/
        ...
        <div className="relative px-4 pt-12 pb-16 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
          <div className="lg:col-start-2 lg:pl-8">
            <div className="mx-auto text-base max-w-prose lg:max-w-lg lg:ml-auto lg:mr-0">
              ...
              <h2 className="text-3xl font-semibold leading-8 tracking-tight text-neutral-900 sm:text-4xl">
      ...
      <div className="relative py-16 overflow-hidden bg-white">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-6 prose prose-lg prose-gold text-neutral-600">
            ...
            <p>
              {t('common:estudio_para_03_piano')}
              {new Date().getFullYear()}
            ...
            <ul role="list">
              <li>
                ...
                {t('common:estudio_para_04_piano')}
              </li>
              <li>
                <span className="font-bold text-neutral-900">
              ...
              <li>
                ...
                {t('common:estudio_para_06_piano')}
              </li>
              <li>
                <span className="font-bold text-neutral-900">
